...
static ZITOLoadingView *zitoLoadingView;
...
@implementation ZITOLoadingView
...
{
    zitoLoadingView = [[ZITOLoadingView alloc] initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height) type:LoadingViewDot];
    zitoLoadingView.backgroundColor = [UIColor whiteColor];
    zitoLoadingView.center = view.center;
    [view addSubview:zitoLoadingView];
}
+ (void)showLineView:(UIView *)view
{
    
    zitoLoadingView = [[ZITOLoadingView alloc] initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height) type:LoadingViewLine];
    zitoLoadingView.backgroundColor = [UIColor whiteColor];
    zitoLoadingView.center = view.center;
    [view addSubview:zitoLoadingView];
}
+ (void)showCircleView:(UIView *)view
{
    ...
    zitoLoadingView = [[ZITOLoadingView alloc] initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height) type:LoadingViewCircle];
    zitoLoadingView.backgroundColor = [UIColor whiteColor];
    zitoLoadingView.center = view.center;
    [view addSubview:zitoLoadingView];
...
{
    zitoLoadingView = [[ZITOLoadingView alloc] initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height) type:LoadingViewCircleJoin];
    zitoLoadingView.backgroundColor = [UIColor whiteColor];
    zitoLoadingView.center = view.center;
    [view addSubview:zitoLoadingView];
...
+ (void)hide{
    ...
    if (zitoLoadingView) {
        [zitoLoadingView removeFromSuperview];
    }
}
